...
def get_swath(radiance_filename, geoloc_filename):
	...
	:param geoloc_filename: MOD03 filename
...
def get_swath_rgb(radiance_filename, geoloc_filename, composite='true_color_uncorrected'):
	"""
	:param radiance_filename: MOD02 filename
	:param geoloc_filename: MOD03 filename
	...
	rgb = np.array(global_scene[composite_name])[:,:2030,:1350]
